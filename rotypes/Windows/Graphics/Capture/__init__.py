...
class GraphicsCaptureSession(
    runtimeclass, IGraphicsCaptureSession, IGraphicsCaptureSession2, IClosable
):
    pass
...
define_winrt_com_method(
    IDirect3D11CaptureFrame, "get_SystemRelativeTime", propget=c_int64
)  # FIXME: Windows.Foundation.TimeSpan
...
define_winrt_com_method(
    ...
    c_int32,
    SizeInt32,
)  # FIXME: Windows.Graphics.DirectX.DirectXPixelFormat
define_winrt_com_method(
    IDirect3D11CaptureFramePool, "TryGetNextFrame", retval=Direct3D11CaptureFrame
)
define_winrt_com_method(
    IDirect3D11CaptureFramePool,
    "add_FrameArrived",
...
define_winrt_com_method(
    IGraphicsCaptureSession2, "get_IsCursorCaptureEnabled", propget=c_bool
)
define_winrt_com_method(
    IGraphicsCaptureSession2, "put_IsCursorCaptureEnabled", propput=c_bool
)
...
runtimeclass_add_statics(
    Direct3D11CaptureFramePool, IDirect3D11CaptureFramePoolStatics2
)
