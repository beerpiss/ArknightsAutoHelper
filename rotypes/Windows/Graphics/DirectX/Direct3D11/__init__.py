...
rotypes.idldsl.define_winrt_com_method(
    IDirect3DDxgiInterfaceAccess, "GetInterface", REFGUID, retval=rotypes.IUnknown
)

_CreateDirect3D11DeviceFromDXGIDevice = (
    ctypes.oledll.d3d11.CreateDirect3D11DeviceFromDXGIDevice
)
_CreateDirect3D11DeviceFromDXGIDevice.argtypes = (
    rotypes.IUnknown,
    ctypes.POINTER(rotypes.IInspectable),
)
