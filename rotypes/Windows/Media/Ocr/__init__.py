...
define_winrt_com_method(
    IOcrResult, "get_TextAngle", propget=IReference(c_double), vtbl=7
)
...
define_winrt_com_method(
    ...
    "RecognizeAsync",
    SoftwareBitmap,
    retval=IAsyncOperation(OcrResult),
    vtbl=6,
)
define_winrt_com_method(IOcrEngine, "get_RecognizerLanguage", propget=Language, vtbl=7)

define_winrt_com_method(
    IOcrEngineStatics, "get_MaxImageDimension", propget=c_uint32, vtbl=6
)
define_winrt_com_method(
    IOcrEngineStatics,
    "get_AvailableRecognizerLanguages",
    propget=IVectorView(Language),
    vtbl=7,
)
define_winrt_com_method(
    IOcrEngineStatics, "IsLanguageSupported", Language, retval=c_bool, vtbl=8
)
define_winrt_com_method(
    IOcrEngineStatics, "TryCreateFromLanguage", Language, retval=IOcrEngine, vtbl=9
)
define_winrt_com_method(
    IOcrEngineStatics, "TryCreateFromUserProfileLanguages", retval=IOcrEngine, vtbl=10
)
