...
if os.environ.get("START_EMULATOR", None) is not None:
    os.system(
        r'"C:\Program Files\BlueStacks_bgp64_hyperv\HD-RunApp.exe" -json "{\"app_icon_url\":\"\",\"app_name\":\"arknights\",\"app_url\":\"\",\"app_pkg\":\"com.hypergryph.arknights\"}"'
    )
...
helper.addon(CombatAddon).configure_refill(
    with_item=True, with_originium=False
).combat_on_current_stage(1000)
# 查询所有的 addon
import pprint
